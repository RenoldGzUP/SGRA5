...
$tabla_Inscrito = $_POST["tabla_inscrito"];
...
//LLAMADO A LA FUNCION CONVERTER UTF8
        ...
        $resultset = checkRegisterExistInscritos($tabla_Inscrito,$arrayInscritos[33]);
