...
?>
  ...
  <button type="button" title="Filtrar registros en base a su selección " class="btn btn-default btn-xs pull-right" style="width: 200px" onclick="getValueUsingParentTag()"  ><span class="glyphicon glyphicon-filter"></span> Aplicar filtros</button>
