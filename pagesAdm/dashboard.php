    ...
    <div id="wrapper">
        ...
        <!--<div class="container-fluid " >-->
          <nav class="navbar" align="center" style="background: #d6d5d5;min-height: 25px;;margin-top: -1px" >
            <a  style="width: 125px" class="btn btn-default btn-sm disabled"><span class="glyphicon glyphicon-home"></span> Inicio</a>
            <a href="inscritos.php"  style="margin-left: 18px;width: 100px" class="btn btn-warning btn-sm">Inscritos</a>
            <a href="certificacion.php"  style="margin-left: 18px;width: 100px" class="btn btn-warning btn-sm">Certificación</a>
            <a href="validacion.php"  style="margin-left: 18px;width: 100px" class="btn btn-warning btn-sm">Validación</a>
            <a href="reportes.php"  style="margin-left: 18px;width: 100px" class="btn btn-warning btn-sm">Reportes</a>
            <a href="datos.php"  style="margin-left: 18px;width: 100px" class="btn btn-warning btn-sm">Datos</a>
            <a href="usuarios.php"  style="margin-left: 18px;width: 100px" class="btn btn-warning btn-sm">Usuarios</a>
          </nav>
          <!--   </div>-->
